...
const (
	IndexerService_Index_FullMethodName = "/service.v1.IndexerService/Index"
)
...
func (c *indexerServiceClient) Index(ctx context.Context, in *IndexRequest, opts ...grpc.CallOption) (*IndexResponse, error) {
...
func (UnimplementedIndexerServiceServer) Index(context.Context, *IndexRequest) (*IndexResponse, error) {
...
var IndexerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.v1.IndexerService",
	...
	Metadata: "service/v1/indexer.proto",
}
