...
func (_mock *MockFileIndex) SearchDirectories(ctx context.Context, arg db.SearchDirectoriesParams) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SearchDirectories")
	}

	var r0 []string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, db.SearchDirectoriesParams) ([]string, error)); ok {
		return returnFunc(ctx, arg)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, db.SearchDirectoriesParams) []string); ok {
		r0 = returnFunc(ctx, arg)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, db.SearchDirectoriesParams) error); ok {
		r1 = returnFunc(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
...
// MockFileIndex_SearchDirectories_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SearchDirectories'
type MockFileIndex_SearchDirectories_Call struct {
	*mock.Call
}

// SearchDirectories is a helper method to define mock.On call
//   - ctx context.Context
//   - arg db.SearchDirectoriesParams
func (_e *MockFileIndex_Expecter) SearchDirectories(ctx any, arg any) *MockFileIndex_SearchDirectories_Call {
	return &MockFileIndex_SearchDirectories_Call{Call: _e.mock.On("SearchDirectories", ctx, arg)}
}

func (_c *MockFileIndex_SearchDirectories_Call) Run(run func(ctx context.Context, arg db.SearchDirectoriesParams)) *MockFileIndex_SearchDirectories_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 db.SearchDirectoriesParams
		if args[1] != nil {
			arg1 = args[1].(db.SearchDirectoriesParams)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockFileIndex_SearchDirectories_Call) Return(strings []string, err error) *MockFileIndex_SearchDirectories_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *MockFileIndex_SearchDirectories_Call) RunAndReturn(run func(ctx context.Context, arg db.SearchDirectoriesParams) ([]string, error)) *MockFileIndex_SearchDirectories_Call {
	_c.Call.Return(run)
	return _c
}
