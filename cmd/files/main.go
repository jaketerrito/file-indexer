...
func main() {
	...
	s3, err := storage.NewWithPublicEndpoint(cfg.S3.Endpoint, cfg.S3.PublicEndpoint, cfg.S3.AccessKeyID, cfg.S3.SecretAccessKey, cfg.S3.Secure, cfg.S3.Bucket, cfg.S3.Region)
	if err != nil {
